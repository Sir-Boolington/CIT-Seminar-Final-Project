  ...
  return (
    <div className="relative z-10">
      ...
      <section className="text-center px-7 pt-12 pb-8">
        <span className="inline-block px-3 py-1 rounded-full text-[11px] text-ts-green border border-green-500/25 bg-green-500/[0.08] mb-4">
          AI-powered training
        </span>
        <h1 className="text-3xl font-medium text-ts-text leading-tight mb-3">
          Train against <span className="text-ts-accent2">real</span> cyber threats.
          <br />No risk. All skill.
        </h1>
        <p className="text-sm text-ts-text3 max-w-[420px] mx-auto mb-6 leading-relaxed">
          Two modes. Three difficulty levels. AI-driven social engineering simulations
          and scenario-based training — all scored and tracked to your account.
        </p>
        <div className="flex justify-center gap-3">
          <Link to="/register" className="px-6 py-2.5 rounded-lg text-sm font-medium bg-ts-accent text-white hover:bg-indigo-500 transition-colors">
            Start training
          </Link>
          <a href="#how-it-works" className="px-6 py-2.5 rounded-lg text-sm text-ts-text2 border border-ts-border-h hover:border-ts-accent transition-colors">
            See how it works
          </a>
        </div>
      </section>
      ...
      {/* Threat Statistics — all data from verified sources */}
      <section className="px-7 pb-12 max-w-[620px] mx-auto">
        ...
        <p className="text-[11px] text-ts-text3 text-center max-w-[440px] mx-auto mb-6 leading-relaxed">
          Human error remains the #1 attack vector. Training is the most effective defense — but only if it's realistic, measurable, and engaging.
        </p>
      ...
      <section className="text-center px-7 pb-12">
        <div className="bg-ts-surface border border-ts-border rounded-xl py-8 px-6 max-w-[480px] mx-auto">
          ...
          <Link to="/register" className="inline-block px-7 py-2.5 rounded-lg text-sm font-medium bg-ts-accent text-white hover:bg-indigo-500 transition-colors">
            Create free account
          </Link>
        </div>
      </section>
